...
#ifndef ORDER_MANAGER_SWIFT_H
#define ORDER_MANAGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="order_manager",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13order_manager11AppDelegate")
...
SWIFT_CLASS("_TtC13order_manager17MainFlutterWindow")
